...
class RegionsCommunesChileSeeder extends Seeder
{
    ...
    public function insertUsers(): void
    {
        $now = now();
        $users = [
            [1, '12345678-1', Hash::make("test1234"), 'tester 1', 1, 'test@test.cl', 'tester direccion', '2021-07-25', 'tester vacuna', 1, 1]
        ];
        $users = array_map(function ($users) use ($now) {
            return [
                'id' => $users[0],
                'usuarios_rut' => $users[1],
                'password' => $users[2],
                'usuarios_nombre' => $users[3],
                'usuarios_telefono' => $users[4],
                'usuarios_correo' => $users[5],
                'usuarios_direccion' => $users[6],
                'usuarios_fncto' => $users[7],
                'usuarios_vacuna' => $users[8],
                'comuna_cod' => $users[9],
                'rol_cod' => $users[10],
                'updated_at' => $now,
                'created_at' => $now,
